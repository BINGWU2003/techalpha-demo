        ...
        element={
          <Layout onLogout={handleLogout}>
            <Routes>
              <Route
                path="/"
                element={<Home onStartTask={handleStartTask} />}
              />
              ...
              <Route
                ...
                element={
                  <ReportConfirm
                    onNext={() => navigate("/auto-report/config")}
                    onCancel={() => navigate("/")}
                  />
                }
              />
              <Route
                path="/auto-report/config"
                element={
                  <ReportConfig
                    onBack={() => navigate(-1)}
                    onGenerate={() => navigate("/auto-report/generating")}
                  />
                }
              />
              <Route
                path="/auto-report/generating"
                element={
                  <ReportGenerating
                    onBack={() => navigate(-1)}
                    onViewReport={openReportInNewTab}
                  />
                }
              />
              ...
              <Route
                ...
                element={
                  <CompanyLibrary
                    onBack={() => navigate("/")}
                    onGenerateReport={() => navigate("/auto-report")}
              ...
              <Route
                ...
                element={
                  <ReportLibrary
                    onBack={() => navigate("/")}
                    onCreateReport={() => navigate("/auto-report")}
                    onOpenReport={openReportInNewTab}
                    onEditReport={() => navigate("/auto-report/config")}
                  />
                }
              />
              <Route
                ...
                element={
                  <Alerts
                    onBack={() => navigate("/")}
                    onUpdateReport={() => navigate("/auto-report/config")}
                  />
                }
              />
              ...
              <Route
                ...
                element={
                  <SectorScan
                    onBack={() => navigate("/")}
                    onNext={() => navigate("/sector-scan/phase2")}
                  />
                }
              />
              <Route
                path="/sector-scan/phase2"
                element={
                  <SectorScanPhase2
                    onBack={() => navigate("/sector-scan")}
                    onNext={() => navigate("/sector-scan/phase3")}
                  />
                }
              />
              <Route
                path="/sector-scan/phase3"
                element={
                  <SectorScanPhase3
                    onBack={() => navigate("/sector-scan/phase2")}
                    onNext={() => navigate("/sector-scan/phase4")}
                  />
                }
              />
              <Route
                path="/sector-scan/phase4"
                element={
                  <SectorScanPhase4
                    onBack={() => navigate("/sector-scan/phase3")}
                    onNext={() => navigate("/deep-mine")}
                  />
                }
              />
            </Routes>
