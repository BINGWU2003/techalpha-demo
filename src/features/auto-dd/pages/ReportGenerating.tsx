          ...
          <div className="bg-white border border-[#e4ebf5] rounded-[20px] shadow-[0_8px_28px_rgba(20,38,80,0.04)] p-[22px]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-[12px] mt-[20px]">
              <div className="bg-[#fbfcff] border border-[#e4ebf5] rounded-[14px] p-[13px_14px]">
                <div className="text-[#718096] text-[12px] mb-[6px]">
                  报告对象
                </div>
                <div className="font-bold text-[14px] text-[#14213d]">
                  浙江钠创新能源
                </div>
              </div>
              <div className="bg-[#fbfcff] border border-[#e4ebf5] rounded-[14px] p-[13px_14px]">
          ...
          <div className="bg-white border border-[#e4ebf5] rounded-[20px] shadow-[0_8px_28px_rgba(20,38,80,0.04)] p-[22px]">
            <div className="flex gap-[8px] p-[8px] bg-[#eef3fa] rounded-[16px] w-fit mb-[16px] overflow-x-auto">
              {[
                ...
                <div
                  ...
                  onClick={() =>
                    setActiveTab(
                      tab.id as "generating" | "ready" | "failed" | "archived",
                    )
                  }
            ...
            {activeTab === "generating" && (
              <div className="animate-in fade-in duration-300">
                <div className="flex justify-between items-center gap-[14px] mb-[18px] max-md:flex-col max-md:items-start">
                  <div>
                    <h2 className="m-0 text-[22px] font-bold text-[#14213d]">
                      正在生成报告初稿
                    </h2>
                  ...
                  <div className="flex items-center gap-[14px] max-md:w-full max-md:justify-between">
                    <button
                      onClick={onViewReport}
                      className="border border-[#2f6df6] bg-[#2f6df6] text-white rounded-[12px] px-[16px] py-[10px] text-[14px] font-semibold hover:bg-[#1d4ed8] transition-colors whitespace-nowrap cursor-pointer"
                    >
                      查看当前生成结果
                    </button>
                ...
                <div className="h-[12px] rounded-full bg-[#edf2f9] overflow-hidden m-[12px_0_20px]">
                  ...
                  >
                    <div
                      className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent animate-[flow_1.4s_infinite]"
                  ...
                  {[
                    {
                      dot: "✓",
                      title: "读取企业基础画像",
                      desc: "企业主体、工商信息、行业标签、已有标的池信息已完成读取。",
                      status: "已完成",
                      done: true,
                    },
                    {
                      dot: "✓",
                      title: "整理专利与技术数据",
                      desc: "已完成正极材料相关专利、技术关键词、重点指标信息聚合。",
                      status: "已完成",
                      done: true,
                    },
                    {
                      dot: "3",
                      title: "生成技术能力与产业化分析",
                      desc: "正在结合压实密度、材料路线、量产进展和专利布局生成分析段落。",
                      status: "生成中",
                      current: true,
                    },
                    {
                      dot: "4",
                      title: "生成竞争格局与风险点",
                      desc: "将对同方向企业、替代路线、商业化风险和客户验证风险进行归纳。",
                      status: "等待中",
                    },
                    {
                      dot: "5",
                      title: "生成摘要、目录与结论",
                      desc: "生成管理层摘要、核心判断、后续跟踪建议和报告目录。",
                      status: "等待中",
                    },
                  ].map((step, i) => (
                    <div
                      key={i}
                      className={`grid grid-cols-[32px_1fr_auto] gap-[12px] items-start p-[14px] border rounded-[15px] ${step.current ? "border-[#b8ccff] bg-[#fbfdff]" : "border-[#e4ebf5] bg-white"}`}
                    >
                      <div
                        className={`w-[26px] h-[26px] rounded-full flex items-center justify-center text-[13px] font-extrabold shrink-0 ${step.done ? "bg-[#eaf8f0] text-[#18a957]" : step.current ? "bg-[#2f6df6] text-white" : "bg-[#edf2fa] text-[#8a99b0]"}`}
                      >
                        {step.dot}
                      </div>
                      <div>
                        <div className="text-[15px] font-bold text-[#14213d] mb-[4px]">
                          {step.title}
                        </div>
                        <div className="text-[13px] text-[#718096] leading-[1.55]">
                          {step.desc}
                        </div>
                      </div>
                      <div
                        className={`text-[12px] font-bold px-[10px] py-[6px] rounded-full whitespace-nowrap ${step.done ? "bg-[#eaf8f0] text-[#18a957]" : step.current ? "bg-[#edf4ff] text-[#2f6df6]" : "bg-[#f2f5fa] text-[#7b8798]"}`}
                      >
                        {step.status}
                      </div>
                    </div>
              ...
              <div className="animate-in fade-in duration-300">
                <div className="flex justify-between items-center gap-[14px] mb-[18px]">
                  <div>
                    ...
                    <p className="m-0 mt-[6px] text-[#718096] text-[14px] leading-[1.6]">
                      当前报告为 AI
                      生成初稿，尚未保存为正式版本。你可以直接查看、进入编辑模式、重新生成部分章节，或保存到报告库。
                    </p>
                  </div>
                  <button
                    onClick={onViewReport}
                    className="border border-[#18a957] bg-[#18a957] text-white rounded-[12px] px-[16px] py-[10px] text-[14px] font-semibold hover:bg-[#15803d] transition-colors whitespace-nowrap cursor-pointer"
                  >
                    查看完整报告
                  </button>
                </div>
                ...
                <div className="bg-white border border-[#e4ebf5] rounded-[18px] p-[34px] min-h-[680px]">
                  <div className="border-b border-[#e4ebf5] pb-[24px] mb-[26px]">
                    <h2 className="m-0 mb-[12px] text-[34px] font-bold leading-[1.25] text-[#14213d]">
                      浙江钠创新能源企业初筛报告
                    </h2>
                    <p className="m-0 text-[#718096] text-[14px] leading-[1.7]">
                      报告类型：企业初筛报告 ｜ 生成时间：2026-04-29 15:42 ｜
                      状态：AI 初稿
                    </p>
                  </div>

                  <div className="mb-[28px]">
                    <h3 className="text-[22px] font-bold text-[#14213d] m-0 mb-[12px]">
                      一、企业画像
                    </h3>
                    ...
                    <table className="w-full border-collapse mt-[12px] text-[14px]">
                      <tbody>
                        <tr>
                          <th className="border border-[#e4ebf5] bg-[#f6f8fc] text-[#4a5870] font-bold p-[12px_14px] text-left w-1/4">
                            企业名称
                          </th>
                          <td className="border border-[#e4ebf5] p-[12px_14px] text-left text-[#2e3a50] w-1/4">
                            浙江钠创新能源
                          </td>
                          <th className="border border-[#e4ebf5] bg-[#f6f8fc] text-[#4a5870] font-bold p-[12px_14px] text-left w-1/4">
                            所属方向
                        ...
                        <tr>
                          <th className="border border-[#e4ebf5] bg-[#f6f8fc] text-[#4a5870] font-bold p-[12px_14px] text-left">
                            重点标签
                          </th>
                          <td className="border border-[#e4ebf5] p-[12px_14px] text-left text-[#2e3a50]">
                            钠离子电池、正极材料、产业化验证
                          </td>
                          <th className="border border-[#e4ebf5] bg-[#f6f8fc] text-[#4a5870] font-bold p-[12px_14px] text-left">
                            报告结论
                  ...
                  <div className="mb-[28px]">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-5 gap-[12px] mt-[14px]">
                      <div className="bg-[#f8fbff] border border-[#e4ebf5] rounded-[14px] p-[14px] text-center w-full">
                        <div className="text-[#718096] text-[12px] mb-[8px]">
                          技术能力
                        </div>
                        <div className="text-[24px] font-extrabold text-[#2f6df6]">
                          7.2
                        </div>
                      </div>
                      <div className="bg-[#f8fbff] border border-[#e4ebf5] rounded-[14px] p-[14px] text-center w-full">
            ...
            {activeTab === "failed" && (
              <div className="animate-in fade-in duration-300">
                <div className="border border-[#ffd5d5] bg-[#fff8f8] rounded-[18px] p-[22px]">
                  <h2 className="m-0 mb-[8px] text-[#e84d4d] text-[22px] font-bold">
                    报告生成失败
                  </h2>
                  ...
                  <div className="grid gap-[10px] mt-[18px]">
                    <div className="p-[14px] rounded-[14px] bg-white border border-[#ffdada] flex justify-between gap-[12px]">
                      <div>
                        <strong className="text-[#703333] font-bold">
                          专利数据源请求超时
                        </strong>
                        <br />
                        <span className="text-[#718096] text-[13px]">
                          部分专利引用、权利要求和技术关键词字段未能按时返回。
                        </span>
                      </div>
                      <button className="border border-[#e4ebf5] bg-white rounded-[10px] px-[11px] py-[7px] text-[12px] font-bold text-[#14213d] hover:bg-gray-50 shrink-0">
                        重试该步骤
                      </button>
                    </div>
                  ...
                  <div className="flex gap-[10px] mt-[18px] flex-wrap">
                    <button className="border border-[#2f6df6] bg-[#2f6df6] text-white rounded-[12px] px-[16px] py-[10px] text-[14px] font-semibold hover:bg-[#1d4ed8]">
                      重新生成报告
                    </button>
                    <button className="border border-[#d7e5ff] bg-white text-[#2f6df6] rounded-[12px] px-[16px] py-[10px] text-[14px] font-semibold hover:bg-gray-50">
                      跳过异常数据继续生成
                    </button>
                    <button className="border border-[#ffd4d4] bg-white text-[#e84d4d] rounded-[12px] px-[16px] py-[10px] text-[14px] font-semibold hover:bg-[#fff0f0]">
                      取消任务
                    </button>
                  </div>
                </div>
              ...
              <div className="animate-in fade-in duration-300">
                ...
                <div className="bg-white border border-[#e4ebf5] rounded-[18px] p-[34px] min-h-[680px]">
                  <div className="border-b border-[#e4ebf5] pb-[24px] mb-[26px]">
                    ...
                    <p className="m-0 text-[#718096] text-[14px] leading-[1.7]">
                      正式版本：V1.0 ｜ 入库时间：2026-04-29 15:58 ｜
                      同步状态：已同步至报告库
                    </p>
                  </div>
